...
type streamFeatures struct {
	...
	StartTLS   tlsStartTLS    `xml:",omitempty"` //TODO
...
type saslFailure struct {
	...
	Any     xml.Name `xml:",any"`
	Text    xmlText  `xml:"text,omitempty"`
}
...
type clientMessage struct {
	...
	Subject []xmlText      `xml:"subject,omitempty"`
	Body    []xmlText      `xml:"body,omitempty"`
	Thread  []clientThread `xml:"thread,omitempty"`
	Error   clientError    `xml:",omitempty"`
...
type clientPresence struct {
	...
	Status   []xmlText   `xml:"status,omitempty"`
